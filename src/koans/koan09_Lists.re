...
let koans _ => Mocha.describe "Lists" @@ fun _ => {
  Mocha.it "list literals are denoted by brackets" @@
    fun _ =>
        (__())
            |> Mocha.eq [ 1, 2, 3 ];
